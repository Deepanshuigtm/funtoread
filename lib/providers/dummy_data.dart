...
class Task {
  ...
  factory Task.fromJson(Map<String, dynamic> json) {
    return Task(
      ...
      payoutAmt: json['payout_amt'].toDouble(),
...
final taskProvider = FutureProvider<List<Task>>((ref) async {
  final jsonString = await rootBundle.loadString('assets/dummy_tasks.json');
  final jsonData = json.decode(jsonString) as List;
  return jsonData.map<Task>((json) => Task.fromJson(json)).toList();
});
